        ...
        window.addEventListener('scroll', () => {
            ...
            // Hero parallax
            const backdrop = document.querySelector('.crisis-backdrop');
            if (backdrop) {
                backdrop.style.transform = `translateY(${scrolled * 0.15}px)`;
            }
            
            // Incident nodes parallax
            document.querySelectorAll('.incident-node').forEach((node, index) => {
        ...
        document.querySelectorAll('.incident-service-card, .command-component, .metric-card').forEach(card => {
        ...
        window.addEventListener('load', () => {
            ...
            // Initialize incident node animations
            document.querySelectorAll('.incident-node').forEach((node, index) => {
