        ...
        window.addEventListener('scroll', () => {
            ...
            // Hero parallax
            const backdrop = document.querySelector('.learning-backdrop');
            if (backdrop) {
                backdrop.style.transform = `translateY(${scrolled * 0.15}px)`;
            }
            
            // Training nodes parallax
            document.querySelectorAll('.training-node').forEach((node, index) => {
            ...
            // Learning streams effect
            document.querySelectorAll('.learning-stream').forEach((stream, index) => {
        ...
        document.querySelectorAll('.training-service-card, .training-category, .metric-card').forEach(card => {
        ...
        window.addEventListener('load', () => {
            ...
            // Initialize training node animations
            document.querySelectorAll('.training-node').forEach((node, index) => {
