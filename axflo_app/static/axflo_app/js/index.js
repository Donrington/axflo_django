 ...
 // Enhanced Navigation Toggle with Animation States
        ...
        // Initialize AOS when DOM is loaded and AOS is available
 ...
 function setScrollBasedDelay() {
   ...
   // Enhanced scroll animations with Intersection Observer (renamed to avoid conflicts)
...
window.addEventListener('scroll', () => {
 ...
 // Enhanced interactions and animations
        ...
        // Back to top functionality with progress indicator
        ...
        const indexNewsletterForm = document.querySelector('.newsletter-form');
        if (indexNewsletterForm) {
            indexNewsletterForm.addEventListener('submit', function(e) {
                e.preventDefault();
